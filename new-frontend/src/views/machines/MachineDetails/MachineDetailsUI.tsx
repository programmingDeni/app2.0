...
//view
import TemplateView from "@/views/templates/TempalteDetails";
import TemplateAttributeRow from "@/features/templates/TemplateAttributes/components/TemplateAttributeCard";
  ...
  return (
    <div>
      ...
      >
        ...
        <Button to={`/home`}>→ Zur Startseite</Button>
      </div>
    </div>
  );
}
