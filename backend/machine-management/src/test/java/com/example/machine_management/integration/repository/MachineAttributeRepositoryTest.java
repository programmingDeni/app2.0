...
class MachineAttributeRepositoryTest {
    ...
    void whenSaveAttribute_thenFindByMachine() {
        // given
        MachineAttribute attr = new MachineAttribute(testMachine.getId(), "TestAttr");
        ...
        assertEquals(testMachine.getId(), found.get(0).getMachineId(), "Machine sollte übereinstimmen");
    }
    ...
    void whenFindAll_thenReturnList() {
        MachineAttribute attr1 = new MachineAttribute(testMachine.getId(), "Attr1");
        MachineAttribute attr2 = new MachineAttribute(testMachine.getId(), "Attr2");
